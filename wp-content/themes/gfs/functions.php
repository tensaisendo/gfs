...
/* To DISABLE the cannonical redirection
 * You need to disable it for Gfs for not to being redirected to 8080
 * the actual listen port is 80. You created Gfs with 8080
 * That is why when you click on the Gfs project, you got redirected to :8080
 * the deactivation of the redirect makes you to have no redirection
 */
...
function twentythirteen_setup() {
    /*
     * Makes Twenty Thirteen available for translation. Translations can be added to the /languages/ directory. If you're building a theme based on Twenty Thirteen, use a find and replace to change 'twentythirteen' to the name of your theme in all template files.
     */
...
if (! function_exists ( 'gfs_post_nav' )) :
    /**
     * Affiche les posts Pr�c�dent / Suivant si applicable
     *
     * @since Gfs 1.0
     *
     * @return void
...
function insert_css_in_head() {
    ...
    wp_register_style ( 'style_coaching', get_template_directory_uri () . '/css/coaching.css', '', false, 'screen' );
    wp_enqueue_style ( 'style_coaching' );

    wp_register_style ( 'style_blog', get_template_directory_uri () . '/css/blog.css', '', false, 'screen' );
    ...
    wp_register_style ( 'style_sidebar-right', get_template_directory_uri () . '/css/sidebar-right.css', '', false, 'screen' );
    wp_enqueue_style ( 'style_sidebar-right' );

    wp_register_style ( 'style_sidebar-newsletter', get_template_directory_uri () . '/css/sidebar-newsletter.css', '', false, 'screen' );
    wp_enqueue_style ( 'style_sidebar-newsletter' );

    wp_register_style ( 'capty', get_template_directory_uri () . '/css/capty.css', '', false, 'screen' );
    wp_enqueue_style ( 'capty' );

    wp_register_style ( 'articles-recents', get_template_directory_uri () . '/css/articles-recents.css', '', false, 'screen' );
    wp_enqueue_style ( 'articles-recents' );

    wp_register_style ( 'bootstrap', get_template_directory_uri () . '/css/bootstrap.min.css', '', false, 'screen' );
    wp_enqueue_style ( 'bootstrap' );

    wp_register_style ( 'normalize', get_template_directory_uri () . '/css/normalize.css', '', false, 'screen' );
 ...
 */
function deactivate_useless_widgets() {
    unregister_widget ( 'WP_Widget_Calendar' );
    unregister_widget ( 'WP_Widget_RSS' );
    /*
     * unregister_widget('WP_Widget_Archives'); WP_Widget_Categories WP_Widget_Meta WP_Widget_Pages WP_Widget_Search
     */
}
add_action ( 'widgets_init', 'deactivate_useless_widgets', 1 );

/**
 * Définit le nombre de caractères du Excerpt
 * @param $length
 * @return int
 */
function new_excerpt_length($length) {
    return 100; /* correspond au nb de caracteres */
}
add_filter('excerpt_length', 'new_excerpt_length');

add_action( 'init', 'create_post_type' );
/**
 * Crée un custom post type pour le Lexique
 */
...
register_taxonomy( 'seduction', 'lexique', array( 'hierarchical' => true, 'label' => 'Séduction', 'query_var' => true, 'rewrite' => true ) );